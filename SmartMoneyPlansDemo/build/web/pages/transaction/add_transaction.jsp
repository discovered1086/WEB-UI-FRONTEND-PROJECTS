...
<html>
    ...
    <body>
        ...
        <%@include file="/pages/prompts/search_plan_prompt.jsp" %>
        <div id="allcontent">
                ...
                <div id="content-body">
                    ...
                    <fieldset class="formdata" style="width:85%;">
                        ...
                        <table class="tableinfo" width="100%">
                            ...
                            <tr>
                                <td>&nbsp;&nbsp;</td>
                                <td align="left">Link this transaction to <a href="javascript:display_details2();">
                                        estimates</a> and <a href="javascript:display_details2();">
                                        purchase plans</a></td>
                            </tr>
                            <tr>
